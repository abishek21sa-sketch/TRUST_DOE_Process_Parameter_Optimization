...
def test_project_decision_campaign():
    ...
    assert out["campaign"] == 'Sequential Experiment Campaign'
    assert out["campaign_identity"] == 'safe-recipe dispersion + information frontier'
    assert 'recipe_dispersion' in out
